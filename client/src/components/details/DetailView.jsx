...
// useSelector is used to get the values from redux store
import { useDispatch, useSelector } from "react-redux";

// to get something from url we use useParams
        ...
        <Container >
          ...
          <RightContainer item lg={8} md={8} sm={8} xs={12}>
            ...
            <OffersDescription>
              <Typography>
                <LocalOffer />
                Bank Offer 10% off on Axis Bank Credit Card and Credit Card EMI
                Trxns,up to ₹1750. On orders of ₹5000 and aboveT&C
              </Typography>
              <Typography>
                <LocalOffer />
                Bank Offer 10% off on ICICI Bank Credit Cards (incl. EMI Txns),
                up to ₹1,750. On orders of ₹5,000 and aboveT&C
              </Typography>
              <Typography>
                <LocalOffer />
                ...
                <TableRow>
                  ...
                  >
                    ...
                    */}
                    ...
                    >
                      <Box>
                        <LocationIcon style={{ fontSize: 14, marginRight: "6px" }} />
                      </Box>
                      <Box>
                        <form>
                          <input
